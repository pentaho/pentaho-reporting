 ...
 * <p/>
 * Pentaho Reporting 4.8 was compiled with an invalid file encoding and the SEED value given in this class was
 * corrupted in the process. Since version 5.0, this text is now ASCII only using unicode escapes and thus is
 * no longer affected by compile-time settings.
 */
