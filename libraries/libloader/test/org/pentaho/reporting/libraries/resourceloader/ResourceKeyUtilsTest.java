...
public class ResourceKeyUtilsTest extends TestCase
{
  ...
  public void testGetFactoryParametersFromString()
  {
    ...
    map = ResourceKeyUtils.parseFactoryParametersFromString("\"f:this=that\":" +
        "\"f:null=\":\"f:one=1\":\"f: with spaces = more spaces \":\"f:space= \":\"f:junk\":\"f:one=won\":\"f:nullagain=\"");
    ...
    assertEquals("Invalid value for ' with spaces '", " more spaces ", map.get(new FactoryParameterKey(" with spaces ")));
    ...
    assertTrue("The map should not contain a value for 'junk'", !map.containsKey(new FactoryParameterKey("junk")));
  }
  ...
  public void testGetSchemaFromString()
  {
    ...
    assertEquals("sample", ResourceKeyUtils.readSchemaFromString(ResourceKeyUtils.SERIALIZATION_PREFIX + "sample;"));
    assertEquals("sample2", ResourceKeyUtils.readSchemaFromString(ResourceKeyUtils.SERIALIZATION_PREFIX + "sample2;junk"));
    assertEquals("resourcekey2:sample", ResourceKeyUtils.readSchemaFromString(ResourceKeyUtils.SERIALIZATION_PREFIX + "resourcekey2:sample;"));
    assertEquals("resourcekey2:sample2", ResourceKeyUtils.readSchemaFromString(ResourceKeyUtils.SERIALIZATION_PREFIX + "resourcekey2:sample2;junk"));
  }
}
