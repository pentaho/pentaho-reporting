...
public class InternalStyleKeys
{
  ...
  /**
   * A internal key holding the computed content. The value for the key is defined during the resolving
   * and by all means: Do not even think about touching that key without proper purification of your soul!
   * Clueless messing around with this property will kill you. 
   */
