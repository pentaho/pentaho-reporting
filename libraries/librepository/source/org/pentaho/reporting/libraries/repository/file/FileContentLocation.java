...
public class FileContentLocation extends FileContentEntity implements ContentLocation
{
  ...
  /**
   * Lists all content entities stored in this content-location. This method filters out all files that have an
   * invalid name (according to the repository rules).
   *
  ...
  /**
   * Checks, whether an content entity with the given name exists in this content location. This method
   * will report invalid filenames as non-existent.
   *
   * @param name the name of the new entity.
