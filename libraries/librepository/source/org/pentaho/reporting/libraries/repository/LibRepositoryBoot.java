...
public class LibRepositoryBoot extends AbstractBoot
{
  ...
  /**
   * A attribute name representing the content-entity versioning information. The object used as versioning
   * information is implementation-specific and should only be used to compare equality.
   */
