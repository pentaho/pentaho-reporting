...
public abstract class AbstractReadHandlerFactory<T extends XmlReadHandler>
{
  ...
  /**
   * Configures this factory from the given configuration using the specified
   * prefix as filter.
   *
  ...
  public T getHandler(String namespace, final String tagname)
  {
    ...
    final T fallbackValue = ObjectUtilities.loadAndInstantiate(fallbackName.getClassName(), getClass(), getTargetClass());
