...
/**
 * An event listener list that stores the listeners as weak references. This list behaves like the
 * {@link javax.swing.event.EventListenerList}, but does not create the risk of memory leaks when
 * maintaining listener lists for global objects.
 *
...
public class WeakEventListenerList
{
  ...
  /**
   * Tries to find the given listener <code>l</code>, which has to be stored under
   * the given type.
   *
   * @param t the type of the listener.
   * @param l the listener.
