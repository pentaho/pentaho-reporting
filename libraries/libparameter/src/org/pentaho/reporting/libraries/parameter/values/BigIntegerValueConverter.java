...
public class BigIntegerValueConverter implements ValueConverter
{
  ...
  public String toAttributeValue(final Object o) throws ValueConversionException
  {
    ...
    throw new ValueConversionException("Failed to convert object of type " + o.getClass() + ": Not a big-integer.");
  }
  ...
  public Object toPropertyValue(final String s) throws ValueConversionException
  {
    ...
    {
      throw ValueConversionException.getInstance("Failed to parse string as number", be);
    }
  }
}
