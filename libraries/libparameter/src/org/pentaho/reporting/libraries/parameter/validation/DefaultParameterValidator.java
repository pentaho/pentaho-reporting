...
public class DefaultParameterValidator implements ParameterValidator
{
  ...
  {
    formulaParameterEvaluator = new FormulaParameterEvaluator();
  }

  public FormulaParameterEvaluator getFormulaParameterEvaluator()
  {
    return formulaParameterEvaluator;
  }

  public void setFormulaParameterEvaluator(final FormulaParameterEvaluator formulaParameterEvaluator)
  {
    if (formulaParameterEvaluator == null)
    {
      throw new NullPointerException();
    }
    this.formulaParameterEvaluator = formulaParameterEvaluator;
  }
