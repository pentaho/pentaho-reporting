...
public class SQLDateValueConverter implements ValueConverter
{
  ...
  public String toAttributeValue(final Object o) throws ValueConversionException
  {
    ...
    {
      throw new ValueConversionException("Failed to convert object of type " + o.getClass() + ": Not a SQL-Date.");
    }
  ...
  public Object toPropertyValue(final String s) throws ValueConversionException
  {
    ...
    {
      throw new ValueConversionException("Not a parsable SQL-date");
    }
  }
}