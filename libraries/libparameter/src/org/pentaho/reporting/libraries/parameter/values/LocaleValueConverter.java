...
public class LocaleValueConverter implements ValueConverter
{
  ...
  public String toAttributeValue(final Object o) throws ValueConversionException
  {
    ...
    {
      throw new ValueConversionException("Failed to convert object of type " + o.getClass() + ": Not a Locale.");
    }
  ...
  public Object toPropertyValue(final String s) throws ValueConversionException
  {
    ...
    {
      throw new ValueConversionException("This is no valid locale specification.");
    }
