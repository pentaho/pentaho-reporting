...
package org.pentaho.reporting.libraries.parameter.values;

import java.math.BigDecimal;

/**
 * A class that handles the conversion of {@link BigDecimal} attributes to and from their {@link String}
 * representation.
 *
...
public class BigDecimalValueConverter implements ValueConverter
{
  ...
  public String toAttributeValue(final Object o) throws ValueConversionException
  {
    ...
    throw new ValueConversionException("Failed to convert object of type " + o.getClass() + ": Not a big-decimal.");
  }
  ...
  public Object toPropertyValue(final String s) throws ValueConversionException
  {
    ...
    if (val.length() == 0)
    {
      throw ValueConversionException.getInstance("Failed to convert empty string to number", null);
    }
    ...
    {
      throw ValueConversionException.getInstance("Failed to convert", be);
    }
  }
}
