...
public class ColorValueConverter implements ValueConverter
{
  ...
  public String toAttributeValue(final Object o) throws ValueConversionException
  {
    ...
    {
      throw new ValueConversionException("Failed to convert object of type " + o.getClass() + ": Not a Color.");
    }
   ...
   */
  public Object toPropertyValue(final String value) throws ValueConversionException
  {
    if (value == null)
    {
    ...
    catch (NumberFormatException nfe)
    {
      ...
      throw new ValueConversionException("Failed to parse color text as RGB-number.", nfe);
    }
  }
