...
public class IntegerValueConverter implements ValueConverter
{
  ...
  public String toAttributeValue(final Object o) throws ValueConversionException
  {
    ...
    throw new ValueConversionException("Failed to convert object of type " + o.getClass() + ": Not a integer.");
  }
  ...
  public Object toPropertyValue(final String s) throws ValueConversionException
  {
    ...
    {
      throw ValueConversionException.getInstance("Failed to parse Number", be);
    }
