...
public class StyleDefinitionEditorContext
{
  ...
  {
    final ElementStyleDefinitionChangeEvent event = new ElementStyleDefinitionChangeEvent(this, styleDefinition, null);
  ...
  {
    final ElementStyleDefinitionChangeEvent event = new ElementStyleDefinitionChangeEvent(this, styleDefinition, rule);
    final ElementStyleDefinitionChangeListener[] changeListeners =
        listeners.getListeners(ElementStyleDefinitionChangeListener.class);
    for (int i = changeListeners.length - 1; i >= 0; i -= 1)
    {
