...
/**
 * A container for the vertical lineals of all report-root-bands. This container manages the mapping between vertical lineal components and report-root-bands.
 * 
...
public class AllVerticalLinealsComponent extends JPanel
{
  ...
  private class BottomImageBorder extends JPanel
  {
    ...
    protected void paintComponent(final Graphics g)
    {
      ...
      g.drawImage(leftCornerBorder.getImage(), getWidth() - 23, 0, leftCornerBorder.getIconWidth(), leftCornerBorder.getIconHeight(), null);
