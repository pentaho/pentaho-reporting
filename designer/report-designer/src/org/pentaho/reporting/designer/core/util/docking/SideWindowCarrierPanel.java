...
/**
 * The SideWindowCarrierPanel combines the drag-area (to resize the component) with the actual content of the
 * of the SidePanel. The content is stored in a list and each update builds a hierarchy of splitpanes to display
