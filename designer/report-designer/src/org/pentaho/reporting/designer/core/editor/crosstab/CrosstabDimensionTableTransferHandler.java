...
public class CrosstabDimensionTableTransferHandler extends TransferHandler
{
  private JTable targetList;
  private CrosstabDimensionTableModel listModel;

  public CrosstabDimensionTableTransferHandler(final JTable targetList,
                                               final CrosstabDimensionTableModel listModel)
  {
    ...
    try
    {
      ...
      if (idx == -1)
      {
        for (int i = 0; i < items.size(); i++)
        {
          ...
          listModel.add(new CrosstabDimension(item));
        }
      }
      else
      {
        ...
        {
          final String item = items.get(i);
          listModel.add(idx, new CrosstabDimension(item));
        }
      }
    }
    catch (Exception e)
  ...
  protected Transferable createTransferable(final JComponent c)
  {
    ...
    for (int i = 0; i < selectedRows.length; i++)
    {
      ...
      final CrosstabDimension crosstabDimension = listModel.get(row);
