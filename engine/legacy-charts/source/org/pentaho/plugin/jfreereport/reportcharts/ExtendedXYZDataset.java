...
/**
 * This class is allows us to accumulate the maximum z value
 * during data collection and hand that value to the chart at render time -
 * without creating a tighter coupling between the data and rendering classes.
 *
