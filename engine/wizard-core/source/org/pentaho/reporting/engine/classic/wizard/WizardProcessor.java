...
public class WizardProcessor extends AbstractReportPreProcessor
{
  ...
  private static class UpdateHeaderTask implements UpdateTask
  {
    ...
    public void processElement(final ReportElement e)
    {
      ...
      {
        e.setAttribute(AttributeNames.Wizard.NAMESPACE, AttributeNames.Wizard.CACHED_WIZARD_FIELD_DATA, groupDefinition);
      }
    }
  }
  ...
  private static class UpdateFooterTask implements UpdateTask
  {
    ...
    public void processElement(final ReportElement e)
    {
      if (Boolean.TRUE.equals
          (e.getAttribute(AttributeNames.Wizard.NAMESPACE, AttributeNames.Wizard.ALLOW_METADATA_STYLING)))
      {
        e.setAttribute(AttributeNames.Wizard.NAMESPACE, AttributeNames.Wizard.CACHED_WIZARD_FORMAT_DATA, groupDefinition.getFooter());
      }
      if (Boolean.TRUE.equals
          (e.getAttribute(AttributeNames.Wizard.NAMESPACE, AttributeNames.Wizard.ALLOW_METADATA_ATTRIBUTES)))
      {
  ...
  private static class UpdateDetailsTask implements UpdateTask
  {
    ...
    public void processElement(final ReportElement e)
    {
      ...
      if (Boolean.TRUE.equals
          (e.getAttribute(AttributeNames.Wizard.NAMESPACE, AttributeNames.Wizard.ALLOW_METADATA_STYLING)))
      {
        e.setAttribute(AttributeNames.Wizard.NAMESPACE, AttributeNames.Wizard.CACHED_WIZARD_FORMAT_DATA, fieldDefinition);
      ...
      if (Boolean.TRUE.equals
          (e.getAttribute(AttributeNames.Wizard.NAMESPACE, AttributeNames.Wizard.ALLOW_METADATA_ATTRIBUTES)))
      {
        e.setAttribute(AttributeNames.Wizard.NAMESPACE, AttributeNames.Wizard.CACHED_WIZARD_FIELD_DATA, fieldDefinition);
      }
    }
  }
 ...
 */
                            ...
                            final int fieldIdx) throws ReportProcessingException
  {
    ...
    {
      detailElement.setAttribute(AttributeNames.Wizard.NAMESPACE, AttributeNames.Wizard.CACHED_WIZARD_FORMAT_DATA, field);
    }
    if (Boolean.TRUE.equals
        (detailElement.getAttribute(AttributeNames.Wizard.NAMESPACE, AttributeNames.Wizard.ALLOW_METADATA_ATTRIBUTES)))
    {
      detailElement.setAttribute(AttributeNames.Wizard.NAMESPACE, AttributeNames.Wizard.CACHED_WIZARD_FIELD_DATA, field);
    }
    ...
    if (detailsHeader != null)
    {
      ...
      {
        headerElement.setAttribute(AttributeNames.Wizard.NAMESPACE, AttributeNames.Wizard.CACHED_WIZARD_FORMAT_DATA, field);
      }
      if (Boolean.TRUE.equals
          (headerElement.getAttribute(AttributeNames.Wizard.NAMESPACE, AttributeNames.Wizard.ALLOW_METADATA_ATTRIBUTES)))
      {
        headerElement.setAttribute(AttributeNames.Wizard.NAMESPACE, AttributeNames.Wizard.CACHED_WIZARD_FIELD_DATA, field);
      }
    ...
    if (detailsFooter != null)
    {
      ...
      {
        footerElement.setAttribute(AttributeNames.Wizard.NAMESPACE, AttributeNames.Wizard.CACHED_WIZARD_FORMAT_DATA, field);
      }
      if (Boolean.TRUE.equals
          (footerElement.getAttribute(AttributeNames.Wizard.NAMESPACE, AttributeNames.Wizard.ALLOW_METADATA_ATTRIBUTES)))
      {
        footerElement.setAttribute(AttributeNames.Wizard.NAMESPACE, AttributeNames.Wizard.CACHED_WIZARD_FIELD_DATA, field);
      }
                                            ...
                                            final GroupDefinition groupDefinition)
  {
    ...
    if (headerDefinition.isVisible())
    {
      ...
      headerElement.setAttribute(AttributeNames.Wizard.NAMESPACE, AttributeNames.Wizard.CACHED_WIZARD_FORMAT_DATA, headerDefinition);
      headerElement.setAttribute(AttributeNames.Wizard.NAMESPACE, AttributeNames.Wizard.CACHED_WIZARD_FIELD_DATA, groupDefinition);
      ...
      throws ReportProcessingException
  {
    ...
    footerElement.setAttribute(AttributeNames.Wizard.NAMESPACE, AttributeNames.Wizard.CACHED_WIZARD_FIELD_DATA, groupDefinition);
      ...
      throws ReportProcessingException
  {
    ...
    final Element footerValueElement = AutoGeneratorUtility.generateFooterElement
        (aggFunctionClass, computeElementType(groupDefinition),
            groupDefinition.getGroupName(), groupDefinition.getField());
    footerValueElement.setAttribute(AttributeNames.Wizard.NAMESPACE, AttributeNames.Wizard.CACHED_WIZARD_FORMAT_DATA, footer);
    footerValueElement.setAttribute(AttributeNames.Wizard.NAMESPACE, AttributeNames.Wizard.CACHED_WIZARD_FIELD_DATA, groupDefinition);
