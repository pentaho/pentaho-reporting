...
public class SqlDataFactoryDriverTest extends DataSourceTestBase
{
  static final String[][] QUERIES_AND_RESULTS = new String[][]{
      {"SELECT * FROM Customers", "query-1.txt"}
  };

  public SqlDataFactoryDriverTest()
  {
  }

  public SqlDataFactoryDriverTest(final String s)
  {
    super(s);
  }
