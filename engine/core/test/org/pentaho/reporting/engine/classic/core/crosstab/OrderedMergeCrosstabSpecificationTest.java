...
public class OrderedMergeCrosstabSpecificationTest extends TestCase
{
  public OrderedMergeCrosstabSpecificationTest()
  {
  }

  public OrderedMergeCrosstabSpecificationTest(final String name)
  {
    super(name);
  }
