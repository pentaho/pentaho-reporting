...
public class SubReportParameterPassingTest extends TestCase
{
  ...
  public void testParameterPassing() throws Exception
  {
    ...
    report.setQuery(SubReportParameterPassingTest.class.getName() + "#createMainTableModel()");
    ...
    subReport.setQuery(SubReportParameterPassingTest.class.getName() + "#createSubReportTableModel(c1)");
  ...
  public static TableModel createSubReportTableModel(String param1)
  {
    ...
    return new DefaultTableModel(new String[][]{{"1.1:" + param1, "1.2:" + param1}, {"2.1:" + param1, "2.2:" + param1}},
        new String[]{"t1", "t2"});
  }
}