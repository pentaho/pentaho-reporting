...
public class SqlDataFactoryJndiTest extends DataSourceTestBase
{
  private static final String[][] QUERIES_AND_RESULTS = new String[][]{
      {"SELECT * FROM Customers", "query-1.txt"}
  };

  public SqlDataFactoryJndiTest()
  {
  }

  public SqlDataFactoryJndiTest(final String s)
  {
    super(s);
  }
  ...
  {
    final SqlDataFactoryJndiTest test = new SqlDataFactoryJndiTest();
    test.setUp();
