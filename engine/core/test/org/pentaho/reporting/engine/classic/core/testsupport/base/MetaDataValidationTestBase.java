...
public class MetaDataValidationTestBase<M extends MetaData>
{
  ...
  protected void validate(final MetaData metaData)
  {
    ...
    if (metaData.isDeprecated())
    {
      ...
      {
        logger.warn("MetaData '" + metaData.getClass().getSimpleName() + ":" + typeName + ": No valid deprecate message");
      }
    }
    ...
    {
      logger.warn("MetaData '" + metaData.getClass().getSimpleName() + ":" + typeName + ": No valid description message");
    }
    ...
    {
      logger.warn("MetaData '" + metaData.getClass().getSimpleName() + ":" + typeName + ": No valid grouping-ordinal message");
    }
  }
