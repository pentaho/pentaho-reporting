...
public class SortedMergeCrosstabSpecificationTest extends TestCase {
  public SortedMergeCrosstabSpecificationTest() {
  }

  public SortedMergeCrosstabSpecificationTest( final String name ) {
    super( name );
  }
