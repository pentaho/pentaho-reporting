 ...
 */
public class PdfEncryptionValidateTest extends TestCase
{
  private static final Log logger = LogFactory.getLog(PdfEncryptionValidateTest.class);

  public PdfEncryptionValidateTest()
  {
  }
