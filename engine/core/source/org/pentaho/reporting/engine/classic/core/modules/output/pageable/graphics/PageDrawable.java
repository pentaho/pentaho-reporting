...
public interface PageDrawable
{
  ...
  /**
   * Returns all layouted render-nodes that occupy the given point and which have the attribute specified by
   * name and namespace set. If name and namespace are null, all elements are returned. All units are given
   * in the same coordinate system used for rendering via the "draw" method.
   *
  ...
  /**
   * Returns all layouted render-nodes that occupy the given area and which have the attribute specified by
   * name and namespace set. If name and namespace are null, all elements are returned. All units are given
   * in the same coordinate system used for rendering via the "draw" method.
   *
   * @param x the x coordinate of the origin of the area.
   * @param y the y coordinate of the origin of the area.
   * @param width the height of the area.
   * @param height the width of the area.
   * @param namespace the attribute's namespace.
   * @param name the attribute's name.
   * @return the nodes for the given point, or an empty array, but never null.
   */
