...
public class FastExcelExportProcessor extends AbstractReportProcessor
{
  private static class ExcelDataOutputProcessor extends AbstractOutputProcessor
  {
    ...
    {
      metaData = new ExcelOutputProcessorMetaData(CSVOutputProcessorMetaData.PAGINATION_NONE);
    }
  ...
  {
    return new FastExportOutputFunction(new FastExcelExportTemplate(outputStream));
  }
