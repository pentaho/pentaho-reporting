...
public abstract class AbstractMetaDataReadHandler extends AbstractXmlReadHandler
{
  ...
  /**
   * This method should be abstract, and will be in the near future and only exists as default implementation
   * to honor the strict requirements of preserving a stable API. Override it in your sub-classes.
   *
    ...
    catch (IllegalArgumentException e)
    {
      if (getLocator() != null)
      {
        logger.debug(String.format
            ("Invalid attribute-value for maturity-level in metadata declaration [Line {0}, Column {1}]",
