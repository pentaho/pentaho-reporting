...
public class PropertyAttributes extends BeanPropertyLookupParser implements Attributes
{
   ...
   * return the value "CDATA" as stated in the XML 1.0 Recommentation (clause 3.3.3, "Attribute-Value
  ...
  /**
   * Look up an attribute's type by XML 1.0 qualified name. <p/> <p>See {@link #getType(int) getType(int)} for a
  ...
  /**
   * Look up an attribute's value by XML 1.0 qualified name. <p/> <p>See {@link #getValue(int) getValue(int)} for a
