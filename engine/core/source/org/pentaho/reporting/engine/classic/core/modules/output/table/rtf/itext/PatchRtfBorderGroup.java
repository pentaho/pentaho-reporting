...
/**
 * The PatchRtfBorderGroup represents a collection of RtfBorders to use in a PatchRtfCell
 * or PatchRtfTable.
 * 
...
public class PatchRtfBorderGroup extends RtfElement {
     ...
     * PatchRtfBorder.ROW_BORDER or PatchRtfBorder.CELL_BORDER
     */
    ...
    private void setBorder(int borderPosition, int borderStyle, float borderWidth, Color borderColor) {
        PatchRtfBorder border = new PatchRtfBorder(this.document, this.borderType, borderPosition, borderStyle, borderWidth, borderColor);
