...
public class ReportProcessTaskRegistry
{
  ...
  public void registerFromXml(final URL expressionMetaSource) throws IOException
  {
    ...
    try
    {
      final Resource resource = resourceManager.createDirectly(expressionMetaSource, ReportProcessTaskMetaDataCollection.class);
      final ReportProcessTaskMetaDataCollection typeCollection = (ReportProcessTaskMetaDataCollection) resource.getResource();
