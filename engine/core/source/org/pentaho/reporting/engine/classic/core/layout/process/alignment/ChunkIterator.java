...
public class ChunkIterator implements Iterator<AlignmentChunk>, Cloneable
{
  ...
  public ChunkIterator(final SequenceList sequenceList,
  ...
  public AlignmentChunk next()
  {
    ...
    for (int i = startPosition + 1; i < sequenceList.size(); i += 1)
    {
      ...
      lastNodeWasSpacer = (classification == InlineSequenceElement.Classification.CONTENT &&
          sequenceList.getNode(i).getNodeType() == LayoutNodeTypes.TYPE_NODE_SPACER);
