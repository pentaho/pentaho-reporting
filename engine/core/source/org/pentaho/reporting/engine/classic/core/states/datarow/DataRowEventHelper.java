...
public class DataRowEventHelper {
  public static void addColumns( final DataRow dataRow,
                                 final MasterDataRowChangeHandler globalView ) {
  ...
  public static void removeAllColumns( final DataRow dataRow,
                                       final MasterDataRowChangeHandler globalView ) {
    final MasterDataRowChangeEvent event = globalView.getReusableEvent();
