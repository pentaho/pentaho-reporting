 ...
 * The PatchRtfCell is an extension of Cell, that supports a multitude of different
 * borderstyles.
 * 
...
public class PatchRtfCell extends Cell implements RtfExtendedElement {
    ...
    private void importCell(Cell cell) {
        ...
        if(cell == null) {
            this.borders = new PatchRtfBorderGroup(this.document, PatchRtfBorder.CELL_BORDER, this.parentRow.getParentTable().getBorders());
            return;
        }
        ...
        if(cell instanceof PatchRtfCell) {
            this.borders = new PatchRtfBorderGroup(this.document, PatchRtfBorder.CELL_BORDER, ((PatchRtfCell) cell).getBorders());
        } else {
...
//			}
    ...
    /**
     * Checks whether this PatchRtfCell is a placeholder for
