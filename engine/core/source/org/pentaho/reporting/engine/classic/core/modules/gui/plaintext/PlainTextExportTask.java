...
public class PlainTextExportTask implements Runnable {
  ...
  ( final MasterReport report,
    ...
    charPerInch = ParserUtil.parseFloat( report.getReportConfiguration().getConfigProperty
    ...
    try {
      ...
      if ( statusListener != null ) {
        statusListener.setStatus
          ( StatusType.INFORMATION, messages.getString( "PlainTextExportTask.USER_TASK_FINISHED" ),
            null ); //$NON-NLS-1$
      }
