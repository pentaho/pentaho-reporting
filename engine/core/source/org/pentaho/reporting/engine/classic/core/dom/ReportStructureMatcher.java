...
public class ReportStructureMatcher
{
  ...
  public static ReportElement[] findElementsByAttribute (final ReportElement section, final String ns, final String name)
  {
    return findElementsByAttribute(section, ns, name, null);
  }

  public static ReportElement[] findElementsByAttribute (final ReportElement section, final String ns, final String name, final Object value)
  {
