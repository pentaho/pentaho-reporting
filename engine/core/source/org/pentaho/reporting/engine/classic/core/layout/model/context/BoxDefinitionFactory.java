...
public final class BoxDefinitionFactory {
  ...
  public BoxDefinition getBoxDefinition( final StyleSheet es ) {
    ...
    if ( cc == null ) {
      ...
      cache
        .put( new CacheKey( id, es.getClass().getName() ), new CacheCarrier( es.getChangeTracker(), boxDefinition ) );
      return boxDefinition;
    }
  ...
  private BoxDefinition createBoxDefinition( final StyleSheet style ) {
    ...
    box.setSizeSpecifiesBorderBox(
      BoxSizing.BORDER_BOX.equals( style.getStyleProperty( ElementStyleKeys.BOX_SIZING ) ) );
