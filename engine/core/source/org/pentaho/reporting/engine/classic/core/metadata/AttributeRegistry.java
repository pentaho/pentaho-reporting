...
/**
 * The attribute registry allows to update the available attributes for an element. The update
 * should happen during the boot-process or reports may behave inconsistently.
 */
