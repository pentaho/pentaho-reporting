...
public class TextStyleKeys {
   ...
   * meanings, which must be interpreted according to the white space processing rules: <p/> <ul> <li>collapse</li>
   * <p>This value directs user agents to collapse sequences of white space into a single character (or in some cases,
   * no character).</p> <li>preserve</li> <p>This value prevents user agents from collapsing sequences of white space.
   * Line breaks are preserved.</p> <li>preserve-breaks</li> <p>This value collapses white space as for 'collapse', but
   * preserves line breaks.</p> <li>discard</li> <p>This value directs user agents to "discard" all white space in the
   * element.</p> </ul>
   */
