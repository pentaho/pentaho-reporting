...
public class SubReportDefinitionWriter extends AbstractXMLDefinitionWriter {
   ...
   * writers.
   *
   * @throws java.io.IOException                                                                      if there is an I/O
   *                                                                                                  problem.
   * @throws org.pentaho.reporting.engine.classic.core.modules.parser.extwriter.ReportWriterException if the report
   *                                                                                                  serialisation
   *                                                                                                  failed.
   */
