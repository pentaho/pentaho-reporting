...
public interface ElementType extends DataSource {
   ...
   * the fully computed style must be retrieved via the {@link org.pentaho.reporting.engine.classic.core
   * .Element#getComputedStyle()}
   * method. The local style-sheet for the element may not have all information.
   *
   ...
   * set it here.
   * <p/>
   * Any value set here will be treated as user-defined value afterwards and will be explicitly stored in the XML
   * files.
   *
