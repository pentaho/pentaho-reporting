...
public class SurveyScaleType extends ContentType
{
  ...
  public Object getValue(final ExpressionRuntime runtime, final ReportElement element)
  {
    ...
    final Number lowerMargin = ElementTypeUtils.getNumberAttribute
        (element, SurveyModule.NAMESPACE, SurveyModule.LOWER_MARGIN, null);
    if (lowerMargin != null)
    {
      drawable.setLowerMargin(lowerMargin.doubleValue());
    }
    final Number upperMargin = ElementTypeUtils.getNumberAttribute
        (element, SurveyModule.NAMESPACE, SurveyModule.UPPER_MARGIN, null);
    if (upperMargin != null)
    {
