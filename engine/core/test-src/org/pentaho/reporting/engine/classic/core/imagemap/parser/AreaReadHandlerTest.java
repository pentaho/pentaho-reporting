...
public class AreaReadHandlerTest {
  ...
  public void testParseCoordsException() throws Exception {
    ...
    exception.expectMessage( "Unable to convert array-text to real array." );
  ...
  public void testRectParsingException() throws Exception {
    exception.expect( ParseException.class );
    exception.expectMessage( "Rect-shape needs four coordinate-values" );
  ...
  public void testDefaultRectParsingException() throws Exception {
    exception.expect( ParseException.class );
    exception.expectMessage( "Implied Rect-shape needs four coordinate-values" );
  ...
  public void testCircleParsingException() throws Exception {
    exception.expect( ParseException.class );
    exception.expectMessage( "Circle-shape needs three coordinate-values" );
  ...
  public void testPolyParsingException() throws Exception {
    exception.expect( ParseException.class );
    exception.expectMessage( "Polygon-shape needs an even number of coordinate-values" );
