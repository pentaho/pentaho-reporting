...
public class StylePageGenerator
{
  ...
  private static String computeValueTypeText(final StyleKey key, final StyleMetaData data)
  {
    ...
    {
      return "ElementAlignment: " + printArray(ElementAlignment.TOP, ElementAlignment.MIDDLE, ElementAlignment.BOTTOM);
    }
    if (key.equals(ElementStyleKeys.ALIGNMENT))
    {
      return "ElementAlignment: " + printArray(ElementAlignment.LEFT, ElementAlignment.CENTER, ElementAlignment.RIGHT);
    }
