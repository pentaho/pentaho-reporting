...
import org.pentaho.reporting.engine.classic.extensions.datasources.olap4j.parser.DenormalizedMDXDataSourceXmlFactoryModule;
...
import org.pentaho.reporting.engine.classic.extensions.datasources.olap4j.parser.LegacyBandedMDXDataSourceXmlFactoryModule;
...
import org.pentaho.reporting.engine.classic.extensions.datasources.olap4j.parser.SimpleBandedMDXDataSourceXmlFactoryModule;
import org.pentaho.reporting.engine.classic.extensions.datasources.olap4j.parser.SimpleDenormalizedMDXDataSourceReadHandler;
import org.pentaho.reporting.engine.classic.extensions.datasources.olap4j.parser.SimpleDenormalizedMDXDataSourceXmlFactoryModule;
import org.pentaho.reporting.engine.classic.extensions.datasources.olap4j.parser.SimpleLegacyBandedMDXDataSourceReadHandler;
import org.pentaho.reporting.engine.classic.extensions.datasources.olap4j.parser.SimpleLegacyBandedMDXDataSourceXmlFactoryModule;
...
public class Olap4JDataFactoryModule extends AbstractModule
{
  ...
  public void initialize(final SubSystem subSystem) throws ModuleInitializeException
  {
    ...
    OlapConnectionReadHandlerFactory.getInstance().setElementHandler(NAMESPACE, "connection", DriverConnectionReadHandler.class);
    OlapConnectionReadHandlerFactory.getInstance().setElementHandler(NAMESPACE, "jndi", JndiConnectionReadHandler.class);
