 ...
 * @author Baochuan Lu
 */
public class GoToLastPageActionPlugin extends AbstractActionPlugin implements
ControlActionPlugin
{
  ...
  public ImageDescriptor getImageDescriptor()
  {
    ...
    {
      return iconTheme.getImageDescriptor(locale, "action.lastpage.small-icon"); //$NON-NLS-1$
    }
  }
}
