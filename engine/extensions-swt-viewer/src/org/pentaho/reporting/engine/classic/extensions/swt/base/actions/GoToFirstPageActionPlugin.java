 ...
 *
 * ------------
 * GoToFirstPageActionPlugin.java
 * ------------
 * (C) Copyright 2001-2007, by Object Refinery Ltd, Pentaho Corporation and Contributors.
 */
 ...
 * @author Baochuan Lu
 */
public class GoToFirstPageActionPlugin extends AbstractActionPlugin implements
ControlActionPlugin
{
  ...
  public ImageDescriptor getImageDescriptor()
  {
    ...
    {
      return iconTheme
      .getImageDescriptor(locale, "action.firstpage.small-icon"); //$NON-NLS-1$
    }
  }
}
