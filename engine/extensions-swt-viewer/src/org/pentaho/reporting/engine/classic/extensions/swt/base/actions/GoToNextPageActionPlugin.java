 ...
 * @author Baochuan Lu
 */
public class GoToNextPageActionPlugin extends AbstractActionPlugin implements
ControlActionPlugin
{
  ...
  {
    reportPane.setPageNumber(Math.min(reportPane.getNumberOfPages(), reportPane
        .getPageNumber() + 1));
    return true;
  }
  ...
  public ImageDescriptor getImageDescriptor()
  {
    ...
    {
      return iconTheme.getImageDescriptor(locale, "action.forward.small-icon"); //$NON-NLS-1$
    }
  }
}
