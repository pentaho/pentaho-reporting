...
package org.pentaho.reporting.engine.classic.extensions.swt.base.event;
...
public class ReportActionEvent extends EventObject
{
  ...
  {
    return node.getAttributes().getAttribute(AttributeNames.Swing.NAMESPACE,
        AttributeNames.Swing.ACTION);
  }
}
