 ...
 * @author Baochuan Lu
 */
public class ZoomOutActionPlugin extends AbstractActionPlugin implements
ControlActionPlugin
{
  ...
  public KeyStroke getAcceleratorKey()
  {
    ...
    .getString("action.zoomOut.char-accelerator");
  ...
  {
    final double nextZoomOut = PreviewPaneUtilities.getNextZoomOut(reportPane
  ...
  public ImageDescriptor getImageDescriptor()
  {
    ...
    {
      return iconTheme.getImageDescriptor(locale, "action.zoomOut.small-icon"); //$NON-NLS-1$
    }
  }
}
