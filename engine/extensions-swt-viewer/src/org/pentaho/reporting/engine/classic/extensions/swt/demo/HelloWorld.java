...
import org.pentaho.reporting.engine.classic.extensions.swt.demo.util.DemoHandler;
import org.pentaho.reporting.engine.classic.extensions.swt.demo.util.DemoSelector;
import org.pentaho.reporting.engine.classic.extensions.swt.demo.util.PreviewHandler;
 ...
 * 
 * ported to SWT by Baochuan Lu 8/17/2008
 */
public class HelloWorld implements DemoHandler
{
  ...
  protected void executeReport (final Shell shell)
  {
...
//    }
  ...
  public static void main (final String[] args)
  {
    ...
    new HelloWorld().executeReport(new Shell());
  }
