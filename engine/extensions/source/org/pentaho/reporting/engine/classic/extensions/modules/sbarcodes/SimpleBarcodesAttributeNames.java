...
public class SimpleBarcodesAttributeNames {
  ...
  /**
   * This attribute represents the height of the bars.<br/> Bar height is often constrained by the barcode total width
   * in order to ensure that barcode readers will read it properly. It means that if this property is set too small it
   * may be (silently) ignored by the barcode element.
   */
