 ...
 *
 */
public class XQDataSourceXmlFactoryModule implements XmlFactoryModule
{

  public XQDataSourceXmlFactoryModule()
  {
  }
  ...
  public int getDocumentSupport(XmlDocumentInfo documentInfo)
  {
    ...
    {
      if (XQueryModule.NAMESPACE.equals(rootNamespace) == false)
      {
        return NOT_RECOGNIZED;
      }
      else if ("xq-datasource".equals(documentInfo.getRootElement()))
      {
  ...
  {
    return new XQDataSourceReadHandler();
  }

  public String getDefaultNamespace(XmlDocumentInfo documentInfo)
  {
    return XQueryModule.NAMESPACE;
  }
}
